 ...
 */
public final class NewOnHeapColumnVector extends NewWritableColumnVector {
   ...
   */
  public static NewOnHeapColumnVector[] allocateColumns(int capacity, StructType schema) {
   ...
   * in number of elements, not number of bytes.
   */
  public static NewOnHeapColumnVector[] allocateColumns(int capacity, StructField[] fields) {
    NewOnHeapColumnVector[] vectors = new NewOnHeapColumnVector[fields.length];
    for (int i = 0; i < fields.length; i++) {
      vectors[i] = new NewOnHeapColumnVector(capacity, fields[i].dataType());
    }
    return vectors;
  }
  ...
  public NewOnHeapColumnVector(int capacity, DataType type) {
    super(capacity, type);
  ...
  @Override
  protected NewOnHeapColumnVector reserveNewColumn(int capacity, DataType type) {
    return new NewOnHeapColumnVector(capacity, type);
  }
}

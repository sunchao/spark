 ...
 */
public final class NewOffHeapColumnVector extends NewWritableColumnVector {
   ...
   */
  public static NewOffHeapColumnVector[] allocateColumns(int capacity, StructType schema) {
   ...
   * in number of elements, not number of bytes.
   */
  public static NewOffHeapColumnVector[] allocateColumns(int capacity, StructField[] fields) {
    NewOffHeapColumnVector[] vectors = new NewOffHeapColumnVector[fields.length];
    for (int i = 0; i < fields.length; i++) {
      vectors[i] = new NewOffHeapColumnVector(capacity, fields[i].dataType());
    }
    return vectors;
  }
  ...
  public NewOffHeapColumnVector(int capacity, DataType type) {
    super(capacity, type);
  ...
  @Override
  protected NewOffHeapColumnVector reserveNewColumn(int capacity, DataType type) {
    return new NewOffHeapColumnVector(capacity, type);
  }
}
